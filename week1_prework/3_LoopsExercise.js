...
for(let i = 0; i <=8; i++){ // start at 0 go up to and including 8 & add 1 each time to the number 
  console.log(i); // prints 0 to 8 
}
...
for (let i = 0; i <101; i++ ){ //start at 0, as long as i is less than 101 (so 100 or lower) add 1 each time to the number 
    if (i == favInt){
